...
add wave -noupdate -radix decimal /architecture_pkg/ram_addr_width
add wave -noupdate -radix decimal /architecture_pkg/ram_chunks
add wave -noupdate -radix decimal /architecture_pkg/ram_subbits
add wave -noupdate -radix decimal /bench/myFPGA/SDRAM/row_width
...
WaveRestoreCursors {{Cursor 1} {11030 ns} 0} {{Cursor 2} {12850 ns} 0}
...
update
WaveRestoreZoom {10720 ns} {11340 ns}
